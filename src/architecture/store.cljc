(ns architecture.store
  "SSoT for the ISCO-08 2162 independent landscape architecture
  practice actor. Store is a protocol injected into the `architecture.actor`
  ...
  Domain:
    ...
    project  — a registered design project (:project-id, :client-id, :name)
    record   — a committed design record under a project
               (design concept, specification draft, environmental note,
               client review material) — written ONLY via
